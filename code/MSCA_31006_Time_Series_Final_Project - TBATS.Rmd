...
smape_tbats_weekly <- smape(test_weekly, forecast_tbats$mean)
print(cat("Symmetric Mean Absolute Percentage Error (MAPE):", round(smape_tbats_weekly, 4), "\n"))
rmse <- rmse(test_weekly, forecast_tbats$mean)
print(cat("Root Mean Squared Error (RMSE):", round(rmse, 2), "\n"))
...
model_tbats$alpha
model_tbats$beta
model_tbats$seasonal.periods
model_tbats$ar.coefficients
model_tbats$ma.coefficients
model_tbats$p
model_tbats$q
model_tbats$likelihood
model_tbats$AIC
